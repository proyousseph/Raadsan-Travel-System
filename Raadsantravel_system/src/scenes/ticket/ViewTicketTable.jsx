...
const Datatablemui = ({ ticketinformation, handleClickEditCat,handleTicketDownloaded, handleInvoiceDownloaded,handleRecDownloaded }) => {
            ...
            {ticketinformation
              ...
              .map((ticket, index) => {
                ...
                return (
                  ...
                  {/* <TableCell onClick={() => handleTicketDownloaded(ticket.ticket_id)}>{ticket.ticket_id}</TableCell>
                    <TableCell onClick={() => handleInvoiceDownloaded(ticket.ticket_id)}>{ticket.customer_title + ". " +ticket.customer_name.split(",")[0]}</TableCell>
                    <TableCell onClick={() => handleRecDownloaded(ticket.ticket_id)}>{ticket.customer_name.split(",")[1]}</TableCell> */}
                    ...
                    <TableCell>
                      <Button
                        ...
                        variant="contained"
                        onClick={() => handleClickEditCat(ticket.ticket_id)}
                      >
